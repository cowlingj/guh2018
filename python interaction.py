...
parser.add_argument('-n', '--name', default=Name, help='Name of bot')
...
while True:
    ...
    if message['Type'] == 'Tank':
        dif_in_x = message['X'] - sself['X']
        dif_in_y = message['Y'] - sself['Y']
        heading = math.atan2(dif_in_y,dif_in_x)
...
#while True:
    ...
    #GameServer.sendMessage(ServerMessageTypes.TOGGLE, {'Amount': random.randint(0, 10)})
